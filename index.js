...
const userGuessedNumber = await inquirer.prompt([
    {
        ...
        type: "number",
        message: "Please guess a number between " + range.min + " to " + range.max + "\n",
    },
]);
if (userGuessedNumber.userGuessedNumber < range.min ||
...
else if (userGuessedNumber.userGuessedNumber + 1 === randomNumber ||
